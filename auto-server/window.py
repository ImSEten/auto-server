...
class Window(object):
    def __init__(self, window_class_name: str, window_name: str, print_hwnd: bool = False, print_text: bool = False) -> None:
        ...
        window_pos, self.hWnd = GetWindow(class_name=self.window_class_name, window_name=self.window_name)
...
def get_screen_scale_factor() -> float:
    globals.global_params.default_screen_scale
    try:
        ...
        print(f"Error: {e}")
        return globals.global_params.default_screen_scale
